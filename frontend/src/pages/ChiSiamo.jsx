            ...
            <div className="page-wrapper">
                ...
                <section className="about-content">
                    <div className="about-container">
                        ...
                        <div className="text-block reveal fade-up">
                            <p>
                        ...
                        <div className="roles-section reveal fade-left">
                        ...
                        <div className="features-list-section reveal fade-right">
                        ...
                        <div className="conclusion-block reveal fade-up">
                            <p>
